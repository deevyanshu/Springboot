package com.deevyanshu.auth.util;
...
public class JwtUtil {
    ...
    public String generateToken(String username){
        ...
        Map<String, Object> claims = Map.of("email", "user@gmail.com");

        return Jwts.builder().subject(username).issuedAt(new Date(System.currentTimeMillis()))
                .expiration(new Date(System.currentTimeMillis() + 1000 * 60 * 5)).claims(claims).
